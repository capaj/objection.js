...
class QueryBuilder extends QueryBuilderBase {
  ...
  applyModifier(...args) {
    deprecate(
      'applyModifier is deprecated. Use the modify method instead. applyModifier will be removed in objection 3.0'
    );

    return this.modify(flatten(args));
  }

  applyFilter(...args) {
    deprecate(
      'applyFilter is deprecated. Use the modify method instead. applyFilter will be removed in objection 3.0'
    );
  ...
  eagerAlgorithm(...args) {
    deprecate(
      '`QueryBuilder#eagerAlgorithm` method is deprecated. You should explicitly use either withGraphFetched or withGraphJoined methods. `eagerAlgoritm` method will be removed in 3.0'
    );

    return this._eagerAlgorithm(...args);
  }

  _eagerAlgorithm(algorithm, eagerOptions) {
    ensureEagerOperation(this, algorithm);

    if (eagerOptions) {
      this._eagerOptions(eagerOptions);
    }
  ...
  eager(...args) {
    ...
    return this._eager(...args);
  }

  _eager(exp, modifiers) {
    ...
    if (modifiers) {
      this.clearModifiers().modifiers(modifiers);
    }
  ...
  joinEager(exp, modifiers) {
    deprecate(
      '`QueryBuilder#joinEager` method is deprecated. You should use the `withGraphJoined` method instead. `joinEager` method will be removed in 3.0'
    );

    return this._eagerAlgorithm(getJoinEagerAlgorithm(this))._eager(exp, modifiers);
  }

  naiveEager(exp, modifiers) {
    deprecate(
      '`QueryBuilder#naiveEager` method is deprecated. You should use the `withGraphFetched` method with the `maxBatchSize: 1` option instead. `naiveEager` method will be removed in 3.0'
    );

    return this._eagerAlgorithm(getNaiveEagerAlgorithm(this))._eager(exp, modifiers);
  }

  mergeEager(...args) {
    deprecate(
      '`QueryBuilder#mergeEager` method is deprecated. You should use the `withGraphFetched` method instead. `mergeEager` method will be removed in 3.0'
    );

    return this._mergeEager(...args);
  }

  _mergeEager(exp, modifiers) {
    const eagerOp = ensureEagerOperation(this);
  ...
  mergeJoinEager(exp, modifiers) {
    deprecate(
      '`QueryBuilder#mergeJoinEager` method is deprecated. You should use the `withGraphJoined` method instead. `mergeJoinEager` method will be removed in 3.0'
    );

    return this._eagerAlgorithm(this.modelClass().JoinEagerAlgorithm)._mergeEager(exp, modifiers);
  }

  mergeNaiveEager(exp, modifiers) {
    deprecate(
      '`QueryBuilder#mergeNaiveEager` method is deprecated. You should use the `withGraphFetched` method with the `maxBatchSize: 1` option instead. `mergeNaiveEager` method will be removed in 3.0'
    );

    return this._eagerAlgorithm(this.modelClass().NaiveEagerAlgorithm)._mergeEager(exp, modifiers);
  }
  ...
  allowEager(exp) {
    ...
    return this.clearAllowGraph().allowGraph(exp);
  }
  ...
  mergeAllowEager(exp) {
    deprecate(
      '`QueryBuilder#mergeAllowEager` method is deprecated. You should use `allowGraph` instead. `mergeAllowEager` method will be removed in 3.0'
    );

    return this.allowGraph(exp);
  }

  eagerObject() {
    deprecate(
      '`QueryBuilder#eagerObject` method is deprecated. You should use `graphExpressionObject` instead. `eagerObject` method will be removed in 3.0'
    );

    return this.graphExpressionObject();
  }
  ...
  eagerModifiers() {
    deprecate(
      '`QueryBuilder#eagerModifiers` method is deprecated. You should use `modifiers` instead. `eagerModifiers` method will be removed in 3.0'
    );
  ...
  eagerModifiersAtPath() {
    deprecate(
      '`QueryBuilder#eagerModifiersAtPath` method is deprecated. You should use `graphModifiersAtPath` instead. `eagerModifiersAtPath` method will be removed in 3.0'
    );

    return this.graphModifiersAtPath();
  }
  ...
  modifyEager(...args) {
    deprecate(
      '`QueryBuilder#modifyEager` method is deprecated. You should use `modifyGraph` instead. `modifyEager` method will be removed in 3.0'
    );

    return this.modifyGraph(...args);
  }
  ...
  filterEager(...args) {
    deprecate(
      '`QueryBuilder#filterEager` method is deprecated. You should use `modifyGraph` instead. `filterEager` method will be removed in 3.0'
    );
  ...
  allowUpsert(exp) {
    deprecate(
      '`QueryBuilder#allowUpsert` method is deprecated. You should use `allowGraph` instead. `allowUpsert` method will be removed in 3.0'
    );
  ...
  allowInsert(exp) {
    deprecate(
      '`QueryBuilder#allowInsert` method is deprecated. You should use `allowGraph` instead. `allowInsert` method will be removed in 3.0'
    );
  ...
  eagerOptions(...args) {
    deprecate(
      '`QueryBuilder#eagerOptions` method is deprecated. You should use `withGraphFetched` or `withGraphJoined` and pass options in the second argument. `eagerOptions` method will be removed in 3.0'
    );

    return this._eagerOptions(...args);
  }
  ...
  hasEager() {
    deprecate(
      `QueryBuilder#hasEager is deprecated. Use hasWithGraph instead. This method will be removed in version 3.0`
    );

    return this.hasWithGraph();
  }
  ...
  isEagerQuery() {
    deprecate(
      `isEagerQuery is deprecated. Use hasWithGraph instead. This method will be removed in version 2.0`
    );
  ...
  clearEager() {
    deprecate(
      '`QueryBuilder#clearEager` method is deprecated. You should use `clearWithGraph` instead. `clearEager` method will be removed in 3.0'
    );

    return this.clearWithGraph();
  }
  ...
  pluck(propertyName) {
    deprecate(`QueryBuilder#pluck is deprecated. This method will be removed in version 3.0`);
  ...
  pick(modelClass, properties) {
    deprecate(`QueryBuilder#pick is deprecated. This method will be removed in version 3.0`);
  ...
  omit(modelClass, properties) {
    deprecate(`QueryBuilder#omit is deprecated. This method will be removed in version 3.0`);
...
function getDefaultEagerAlgorithm(builder) {
  const eagerAlgorithm = builder.modelClass().defaultEagerAlgorithm;

  if (eagerAlgorithm !== getWhereInEagerAlgorithm(builder)) {
    deprecate(
      'Model.defaultEagerAlgorithm is deprecated. You need to use `withGraphFetched` or `withGraphJoined` explicitly. `defaultEagerAlgorithm` will be removed in 3.0'
    );
  }
